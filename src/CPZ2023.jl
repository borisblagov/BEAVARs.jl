...
# Arguments
    ...
    data_strct::BVARmodelDataSetup: The data structure containing the high-frequency data (`dataHF_tab`), variable list (`var_list`), and other relevant information for the model.
"""
