...
function forecast(VAROutput::VAROutput_Chan2020iniw,VARSetup::BVARmodelSetup,data_struct::BVARmodelDataSetup)
...
function forecast(VAROutput::VAROutput_Chan2020iniw,VARSetup::BVARmodelSetup,data_struct::BVARmodelDataSetup,data_true_ftab::TimeArray{T,N,D,A}) where {T <: AbstractFloat, N, D, A <: AbstractArray{T, N}}
    ...
    fcast_ϵ_mat = dropdims(mean(-(Yfor3d[forecast_flags_vec,:,:] .-  data_truef_mat[data_true_flags_vec,:]),dims=3),dims=3);    # forecast errors, average over draws
